      ...
      <div class="header-inner header-md-height">
        ...
        <div class="">
          <div class="brand inline no-border hidden-xs-down">
            <img src="{{ url('images/logo_white.png') }}" alt="logo" data-src="{{ url('images/logo_white.png') }}" data-src-retina="{{ url('images/logo_white_2x.png') }}" width="78" height="22">
          </div>
                      ...
                      <div class="notification-item unread clearfix">
                        <div class="heading">
                          <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                            <img width="30" height="30" data-src-retina="{{ url('images/1x.jpg') }}" data-src="{{ url('images/1.jpg') }}" alt="" src="{{ url('images/1.jpg') }}">
                          </div>
                          <a href="#" class="text-complete pull-left">
          ...
          <div class="dropdown pull-right">
            <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <span class="thumbnail-wrapper d32 circular inline sm-m-r-5">
                <img src="{{ url('images/avatar.jpg') }}" alt="" data-src="{{ url('images/avatar.jpg') }}" data-src-retina="{{ url('images/avatar_small2x.jpg') }}" width="32" height="32">
                </span>
            </button>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" data-src-retina="{{ url('images/1x.jpg') }}" data-src="{{ url('images/1.jpg') }}" alt="" src="{{ url('images/1.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
    ...
    <!-- START OVERLAY -->
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="{{ url('images/logo.png') }}" alt="logo" data-src="assets/img/logo.png" data-src-retina="{{ url('images/logo_2x.png') }}" width="78" height="22">
          <!-- END Overlay Logo !-->
          <!-- BEGIN Overlay Close !-->
